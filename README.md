...
Сейчас прохожу стажировку в Junov.Net (аналог Stepik). Сейчас задействован на этапе проработки требований. Так же параллельно занимаемся разработкой тренажера собеседований для стажеров SobesJunov.Net, тестированием требований. 
