...
В данный момент прохожу стажировку в GSPOT (github.com/DJWOMS/GSpot). Я задействован в проекте по разработке приложения для покупок онлайн- игр (аналог Steam). Я работаю в отделе оплаты и покупок игр(Payments).
Выполняю следующие задачи:
Тестирование API с Postman и Swagger.
Составление тестовой документации в GitHub (https://github.com/victoretc/GSPOTtestingdocumentation).
Так же занимаю позицию наставника для 3-х тестировщиков: распределение задач, помощь при возникновении каких либо вопросов.

Начинал с изучения литературы(Святослав Куликов «Тестирование программного обеспечения. Базовый курс.»), проходил курсы от Яндекс.Практикум и Artsiom Rusau QA.

На курсе Artsiom Rusau QA, обновил свои знания по теории тестирования, API(Postman, Swagger), мобильное тестирование AndoridStudio, SQL(MySQL) и NoSQL(MongoDB), Git и Bash(GitHub).

В Яндекс.Практикуме обучался на основе продуктов Яндекса:
Яндекс.Маршруты(веб-приложение, чек-листы, тест-кейсы, тестирование UI, тестирование веб-приложения, Charles), Яндекс.Метро(тестирование моб.приложений, Android Studio), Яндекс.Прилавок(тестирование API, Postman), Яндекс.Самокат(дипломный проект по всем темам, Веб-приложение, мобильное приложение, API, SQL).
