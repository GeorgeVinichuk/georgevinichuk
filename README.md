...
На данный момент закончил курс от Artsiom Rusau QA Life. Обновлял знания по теории тестирования, тестировании веб и мобильные приложения (Android Studio), работал с API в Postman и Swagger, изучал базовые запросы SQL в MySQL,  NoSQL в MongoDB. Так-же получил базовые знания работы с git и bash и работал в GitHub.
По итогам обучения у Artsiom Rusau QA Life получил возможность попасть на стажировку в GSPOT (github.com/DJWOMS/GSpot)
